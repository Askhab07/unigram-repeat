...
const CreatePublicModal = () => {
  ...
  return (
    <>
      ...
      {step === 2 && (
        <div className="absolute z-50 top-[10%] left-[17.5%]  w-[956px] h-[677px] bg-white shadow-2xl rounded-3xl">
          <div className="h-[70px] flex items-center justify-between px-6 border-b-[1px] border-[#DBDBDB]">
            ...
            <button className="font-semibold text-lg text-[#0095F6]">
              Поделиться
            </button>
          </div>
            ...
            <div className="w-[317px] flex flex-col gap-[18px] mt-2.5 mr-6">
              <div className="flex items-center gap-2.5">
                <img
                  ...
                  alt=""
                />
                <h2 className="font-medium text-sm">askhab.us</h2>
              </div>
              <textarea
